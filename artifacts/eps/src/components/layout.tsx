...
import { BookOpen, CheckSquare, Home, Users, LogOut, List, User } from "lucide-react";
...
export function AuthLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex h-screen w-full bg-background text-foreground overflow-hidden">
      {/* Sidebar */}
      <aside className="w-72 border-r border-border bg-card flex-col justify-between hidden md:flex">
        <div>
        ...
        <div className="p-4 border-t border-border">
          <Link
            href="/account"
            className="flex items-center gap-3 mb-3 px-2 py-2 rounded-md hover:bg-accent transition-colors"
